...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"steel","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!********************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/pages.json ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!****************************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/store/typeStore.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vuexPersist = _interopRequireDefault(__webpack_require__(/*! vuex-persist */ 35));
_vue.default.use(_vuex.default);
var typeStore = new _vuex.default.Store({
  state: {
    count: 0,
    typeList: []
  },
  mutations: {
    ...
    inieTypeList: function inieTypeList(state, payload) {
      state.typeList = payload;
    }
  },
  plugins: [
  // 数据持久化插件
  new _vuexPersist.default({
    localstorage: wx.setStorage()
  }).plugin]
});
var _default = typeStore;
exports.default = _default;
...
/* 35 */
/*!*****************************************************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/node_modules/vuex-persist/dist/esm/index.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = exports.VuexPersistence = exports.MockStorage = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ 18));
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _deepmerge = _interopRequireDefault(__webpack_require__(/*! deepmerge */ 36));
/**
...
{
  exports.MockStorage = MockStorage = /*#__PURE__*/function () {
...
var SimplePromiseQueue = /*#__PURE__*/function () {
  function SimplePromiseQueue() {
    (0, _classCallCheck2.default)(this, SimplePromiseQueue);
    this._queue = [];
    this._flushing = false;
  }
  (0, _createClass2.default)(SimplePromiseQueue, [{
    key: "enqueue",
...
var options = {
  ...
  concatArrays: {
    arrayMerge: function arrayMerge(target, source, options) {
      return target.concat.apply(target, (0, _toConsumableArray2.default)(source));
    }
  }
};
function merge(into, from, mergeOption) {
  return (0, _deepmerge.default)(into, from, options[mergeOption]);
}
 ...
 */
var VuexPersistence = /*#__PURE__*/(0, _createClass2.default)(
/**
...
function VuexPersistence(options) {
  var _this2 = this;
  (0, _classCallCheck2.default)(this, VuexPersistence);
  ...
  if (this.supportCircular) {
    FlattedJSON = __webpack_require__(/*! flatted */ 37);
  }
  ...
  this.reducer = options.reducer != null ? options.reducer : options.modules == null ? function (state) {
    ...
    return options.modules.reduce(function (a, i) {
      return merge(a, (0, _defineProperty2.default)({}, i, state[i]), _this2.mergeOption);
...
/* 37 */
/*!*******************************************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/node_modules/flatted/esm/index.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var Primitives = function Primitives(_, value) {
  return (0, _typeof2.default)(value) === primitive ? new Primitive(value) : value;
};
var revive = function revive(input, parsed, output, $) {
  ...
  for (var ke = keys(output), length = ke.length, y = 0; y < length; y++) {
    ...
    if (value instanceof Primitive) {
      var tmp = input[value];
      if ((0, _typeof2.default)(tmp) === object && !parsed.has(tmp)) {
        parsed.add(tmp);
        output[k] = ignore;
        lazy.push({
          k: k,
...
var parse = function parse(text, reviver) {
  ...
  var value = input[0];
  var $ = reviver || noop;
  var tmp = (0, _typeof2.default)(value) === object && value ? revive(input, new Set(), value, $) : value;
  return $.call({
    '': tmp
  }, '', tmp);
};
...
var stringify = function stringify(value, replacer, space) {
  var $ = replacer && (0, _typeof2.default)(replacer) === object ? function (k, v) {
  ...
  function replace(key, value) {
    ...
    switch ((0, _typeof2.default)(after)) {
      case object:
...
/* 47 */
/*!*********************************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/services/homeService.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getType = exports.getSwiper = exports.getPro = void 0;
...
var getPro = function getPro(data) {
  return uni.request({
...
/* 48 */
/*!************************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/static/bg1.png ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _inherits2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/inherits */ 84));
...
try {
  {
    var _e2 = __webpack_require__(/*! uni-stat-config */ 91).default || __webpack_require__(/*! uni-stat-config */ 91);
    T = _e2.appid;
  }
} catch (e) {}
var A = {};
...
/* 90 */
/*!*************************************************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/pages.json?{"type":"origin-pages-json"} ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  "pages": [{
    ...
    "style": {
      "navigationBarTitleText": "佛山市合芯铝业有限公司"
    }
  }, {
...
/* 91 */
/*!************************************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/pages.json?{"type":"stat"} ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 99 */
/*!*************************************************************************************!*\
  !*** D:/Desktop/全部项目/小程序/steel/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
